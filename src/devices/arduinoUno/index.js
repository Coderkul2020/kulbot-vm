...
class SunyArduinoUnoDevice {
    ...
    constructor (runtime, originalDeviceId) {
        ...
        this._peripheral = new ArduinoUno(this.runtime, SunyArduinoUnoDevice.DEVICE_ID, originalDeviceId);
    }
        ...
        return [
            {
                ...
                blocks: [
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            id: 'arduinoUno.pins.DigitalOutput',
                            default: 'Led digital pin [PIN] out [LEVEL]',
                            description: 'arduinoUno set digital pin out'
                        }),
                        blockType: BlockType.COMMAND,
                        arguments: {
...
module.exports = SunyArduinoUnoDevice;
